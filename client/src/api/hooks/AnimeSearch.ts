...
export type AnimeSearchQueryVariables = Types.Exact<{
...
export const AnimeSearchDocument = `
  ...
  Page(page: $page, perPage: 20) {
    ...
    `;
export const useAnimeSearchQuery = <
      TData = AnimeSearchQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: AnimeSearchQueryVariables,
      options?: UseQueryOptions<AnimeSearchQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<AnimeSearchQuery, TError, TData>(
      variables === undefined ? ['AnimeSearch'] : ['AnimeSearch', variables],
      fetcher<AnimeSearchQuery, AnimeSearchQueryVariables>(client, AnimeSearchDocument, variables, headers),
      options
    );
export const useInfiniteAnimeSearchQuery = <
      ...
      TError = unknown
    >(
      _pageParamKey: keyof AnimeSearchQueryVariables,
      client: GraphQLClient,
      variables?: AnimeSearchQueryVariables,
      options?: UseInfiniteQueryOptions<AnimeSearchQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useInfiniteQuery<AnimeSearchQuery, TError, TData>(
      variables === undefined ? ['AnimeSearch.infinite'] : ['AnimeSearch.infinite', variables],
      (metaData) => fetcher<AnimeSearchQuery, AnimeSearchQueryVariables>(client, AnimeSearchDocument, {...variables, ...(metaData.pageParam ?? {})}, headers)(),
      options
    );
